 ...
 * @author luis
 */
public class frm_ver_clientes_pagos extends javax.swing.JDialog {

    public static cl_cliente c_cliente = new cl_cliente();
    cl_cliente_pago c_pagos = new cl_cliente_pago();
     ...
     */
    public frm_ver_clientes_pagos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        query = "select bm.id_movimiento, b.nombre, bm.fecha, bm.ingresa "
                ...
                + "where cp.id_cliente = '" + c_cliente.getCodigo() + "' "
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        c_movimiento.setIngresa(Double.parseDouble(txt_monto.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_ver_clientes_pagos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frm_ver_clientes_pagos dialog = new frm_ver_clientes_pagos(new javax.swing.JFrame(), true);
