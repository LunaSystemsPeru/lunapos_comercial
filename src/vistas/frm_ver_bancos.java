...
public class frm_ver_bancos extends javax.swing.JInternalFrame {
    ...
    public frm_ver_bancos() {
        ...
        c_banco.mostrar(t_clasificacion, query);
    ...
    private void btn_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificarActionPerformed
        desactivar_botones();
        c_banco.setId_banco(Integer.parseInt(t_clasificacion.getValueAt(fila_seleccionada, 0).toString()));
        c_banco.obtener_datos();
        txt_reg_nombre.setText(c_banco.getNombre());
        txt_reg_id.setText(c_banco.getId_banco()+ "");
