...
public class frm_reg_ingreso extends javax.swing.JInternalFrame {
    ...
    TextAutoCompleter tac_razon_proveedores = null;
    ...
    private void modelo_bono() {
        ...
        t_bonificaciones.getColumnModel().getColumn(2).setPreferredWidth(50);
        c_varios.centrar_celda(t_detalle, 0);
    ...
    private void cargar_proveedores() {
        try {
            ...
            while (rs.next()) {
                tac_proveedores.addItem(rs.getString("razon_social"));
            }
    ...
    private void cargar_proveedores_todos() {
        try {
            if (tac_razon_proveedores != null) {
                tac_razon_proveedores.removeAllItems();
            }
            tac_razon_proveedores = new TextAutoCompleter(txt_razon_social, new AutoCompleterCallback() {
                @Override
            ...
            tac_razon_proveedores.setMode(0);
            tac_razon_proveedores.setCaseSensitive(false);
            Statement st = c_conectar.conexion();
            String sql = "select id_proveedor, razon_social, nro_documento from proveedor";
            ResultSet rs = c_conectar.consulta(st, sql);
            while (rs.next()) {
                tac_razon_proveedores.addItem(new cla_empresa(rs.getInt("id_proveedor"), rs.getString("nro_documento"), rs.getString("razon_social")));
            }
            c_conectar.cerrar(rs);
            c_conectar.cerrar(st);
        } catch (SQLException e) {
    ...
    private void cargar_productos() {
        try {
            ...
            Statement st = c_conectar.conexion();
            String sql = "select p.descripcion, p.precio, p.costo, p.id_producto, p.marca, um.nombre as und_medida "
                    + "from productos as p "
                    + "inner join unidades_medida um on p.id_unidad = um.id_unidad ";
            ResultSet rs = c_conectar.consulta(st, sql);
            while (rs.next()) {
                int id_producto = rs.getInt("id_producto");
                String descripcion = rs.getString("descripcion").trim() + " | " + rs.getString("und_medida")
    ...
    private void initComponents() {
        ...
        jd_fin_ingreso = new javax.swing.JDialog();
        ...
        lab_deuda = new javax.swing.JLabel();
        ...
        jd_fin_ingreso.setTitle("Grabar Venta");

        jPanel5.setBackground(new java.awt.Color(255, 255, 255));

        jLabel18.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel18.setText("Total Ingreso:");
        ...
        jLabel20.setText("My Deuda Total:");
        ...
        javax.swing.GroupLayout jd_fin_ingresoLayout = new javax.swing.GroupLayout(jd_fin_ingreso.getContentPane());
        jd_fin_ingreso.getContentPane().setLayout(jd_fin_ingresoLayout);
        jd_fin_ingresoLayout.setHorizontalGroup(
            jd_fin_ingresoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jd_fin_ingresoLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jd_fin_ingresoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jd_fin_ingresoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(jPanel6, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jPanel5, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addComponent(btn_pago))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jd_fin_ingresoLayout.setVerticalGroup(
            jd_fin_ingresoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jd_fin_ingresoLayout.createSequentialGroup()
                .addContainerGap()
        ...
        btn_add_producto.setText("Crear Producto");
        ...
        btn_agregar_producto.setText("Agregar a la Lista");
        ...
        btn_agregar_producto.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btn_agregar_productoKeyPressed(evt);
            }
        });

        btn_recargar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/currency.png"))); // NOI18N
        btn_recargar.setText("Recargar Productos");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btn_bono, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btn_agregar_productoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_agregar_productoActionPerformed
        ...
        if (btn_bono.getSelectedIndex() == 0) {
            ...
            fila[2] = cantidad;
            fila[3] = c_varios.formato_precio(costo);
            fila[4] = c_varios.formato_precio(precio);
            fila[5] = c_varios.formato_numero(parcial);
...
//            }
    ...
    private void btn_agregar_productoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btn_agregar_productoKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            btn_agregar_producto.doClick();
        }
    }//GEN-LAST:event_btn_agregar_productoKeyPressed
        ...
        if (JOptionPane.OK_OPTION == confirmado) {
            ...
            if (registrado) {
                ...
                for (int i = 0; i < nro_filas_bono; i++) {
                    ...
                    c_bono.setCantidad(Double.parseDouble(t_bonificaciones.getValueAt(i, 2).toString()));
    ...
    private javax.swing.JDialog jd_fin_ingreso;
    private javax.swing.JLabel lab_deuda;
