 ...
 * @author luis
 */
public class frm_reg_producto_original extends javax.swing.JDialog {
     ...
     */
    public frm_reg_producto_original(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
getContentPane().setBackground(Configuracion.COLOR_FORMULARIO_1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_reg_producto_original.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frm_reg_producto_original dialog = new frm_reg_producto_original(new javax.swing.JFrame(), true);
